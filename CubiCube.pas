...
//++++++++++Class representing the Cube on the Cubie Level++++++++++++++++++++++
  ...
  public
    ...
    //+++Set orientation of centers such that the centercoordinate is w+++++++++
     ...
     //++++++++++f�r Coset-Explorer notwendig++++++++++++++++++++++++++++++++++
     procedure InvCorn8PermCoord(w:Word);  //immer als letztes aufrufen, da Parit�t bestimmt wird.

     function cube20TetraCoord : Word;//f�r cube20 Projekt
...
//jetzt evtl. die Positionen erg�nzen, falls nur ein Stein fehlt
...
function CubieCube.CentOriRFLBMod2Coord: Word;//Wichtig f�r den two phase alg, weil Phase 2 diese Koordinate nicht mehr ver�ndert
begin
...
//spezielle tetracoordinate f�r cube20
...
//+++wird ben�tigt, um aus dem Bitvector die Cubes auszulesen, nicht zeitkritisch+++
//erst nach dem Setzen der anderen Koordinaten aufrufen, da die Parit�t richtig werden muss!
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if k=0 then SymCornPosToCornPos[classIdx]:=n; //dieser Teil wird f�r die Pruning Table ben�tigt
      end;
      Inc(classIdx);
    end;
  end;
