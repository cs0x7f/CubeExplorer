...
const SPECIAL4 = false;//Spezielle Version f�r Phase3 von 4x4x4 W�rfel
...
const FULLPHASE2 = false;//Code f�r die Analyse von Phase2, normalerweise false setzen!
const PRIVAT = false;//normalerweise false, f�r spezielle Routinen die nicht �ffentlich sind
const CUBE20STUFF = true;//F�r spezielle Berechnungen des cube20 Projekts
...
//+++++++Symmetries of the TImageList diagrams
  ...
  (281474976710655{O_h},93824992236885{O},168884986026393{T_d},
   ...
   //* ist f�r Antisymmetrie, die hier andere Orientierung hat, siehe TImageList
...
//+++++++++++the positional changes of the cornercubies by faceturns++++++++++++
  ...
  (((c:UBR;o:0),(c:URF;o:0),(c:UFL;o:0),(c:ULB;o:0),  //U
   ...
   ((c:UBR;o:0),(c:URF;o:0),(c:UFL;o:0),(c:ULB;o:0),  //Us    PR�FEN!!!
...
(
  ...
  ((e:UB;o:0),(e:UR;o:0),(e:UF;o:0),(e:UL;o:0),(e:DB;o:0),(e:DR;o:0),  //Us PR�FEN
...
var stopAt,autoTime: Integer;//Two Phase Algorithm Options dialog
    ...
    checkIsomorphics,USES_BIG: Boolean;//pr�fen ob beim Hinzuf�gen auf Isomorphie gepr�ft wird
                                        //falls InvIsomorphics gesetzt auch die Inversen auf Isomorphie �berpr�fen
